...
- Building dynamic geometries according to the scale level.
- Increasing the amount of source information to complement the detail and interaction of the tool such as the official government database. 
- Including different functionality tools, for instance, distance measurement, routes, and download the information in different formats, among others.
